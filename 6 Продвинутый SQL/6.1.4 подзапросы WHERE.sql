...
Нужно собрать всю информацию о пользователях, которые оформили 10 самых крупных заказов. 
Сначала нужно найти таких пользователей — этот запрос выведет идентификаторы пользователей с заказами на самую большую сумму.
*/
