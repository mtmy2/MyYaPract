...
Присутствие
Наличие (присутствие) ключа верхнего уровня в объекте проверяет отдельная группа операторов. 
При этом вложенные объекты не рассматриваются, поскольку они не являются верхним уровнем.
