...
Булево значение true или false — добавлять ли элемент, если по заданному пути ничего не найдётся. Этот атрибут можно не указывать, по умолчанию он равен true.
Допустим, нужно заменить имя сына водителя Колесова «Артем» на «Артём». Путь к этому элементу такой: объект children — в нём элемент массива с индексом 0 — в нём объект name. В формате текстового массива это выглядит так: '{children, 0, name}'. Осталось указать новое значение, заключив его в двойные кавычки, чтобы синтаксис был корректен для формата jsonb. Последний аргумент указывать не нужно:
