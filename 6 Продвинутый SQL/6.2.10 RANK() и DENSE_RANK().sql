...
Функции RANK() и DENSE_RANK() похожи на функцию ROW_NUMBER() и отличаются лишь логикой ранжирования повторяющихся значений. Как вы помните, в случае повтора функция ROW_NUMBER() присваивает такой записи следующий ранг, как в уже знакомом вам запросе:
